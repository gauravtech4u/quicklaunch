...
from registration.views import detail
...
urlpatterns = patterns('',
                       ...
                       url(r'^change_setting/$',
                           'registration.views.change_setting',
                           name='change_setting'),
                       url(r'^get_user_profile/(?P<user_id>[-\w]+)/$',
                           'registration.views.get_user_profile',
