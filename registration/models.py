...
#User.add_to_class('mobile', models.CharField(_('e-mail address'),max_length=128,null=True,blank=True))

class UserProfile(models.Model):
    user = models.ForeignKey(User,related_name='user',unique=True)
    mobile = models.CharField(max_length=20,blank=True,null=True)
    type=models.CharField(choices=TYPE_CHOICES,max_length=200,null=True,blank=True)
    category=models.ForeignKey(CategoryDefault,null=True,blank=True)
    location=models.ForeignKey(Location,null=True,blank=True)
    show_qna=models.IntegerField(default=1,null=True,blank=True)
    show_search=models.IntegerField(default=1,null=True,blank=True)
    show_me=models.IntegerField(default=1,null=True,blank=True)
...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, username, password, email,mobile=None,first_name=None,category=None,
                             type=None,location=None,send_email=True, profile_callback=None):
        """
        ...
        """
        Hacked Registration to activate profile on register 
        """
        ...
        """
        Hacked for some time to disable send mail
        """
        send_email = False
        if send_email:
    ...
    def edit_profile(self,user,profile,form):
        """
        Create a ``RegistrationProfile`` for a given
        ``User``, and return the ``RegistrationProfile``.
        """
